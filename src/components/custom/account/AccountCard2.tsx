...
export function AccountCard2({ accountName, balance, showCard = false, onViewDetails, onCardClick, isLoading = false }: AccountCardProps) {
  return (
    <div className="relative w-[340px] rounded-[16px] px-[24px] py-[11px] bg-primary-1/[0.12] h-[111px]">
      ...
      <div className="mb-[10px] pt-[1px]">
        <p className="text-neutral-1 text-body-04 leading-[31px] font-bold tracking-[-0.6px] whitespace-pre-line">
          계좌 개설 요청 중!
        </p>
      </div>
