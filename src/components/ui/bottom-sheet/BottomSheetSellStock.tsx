 ...
 * - 팔기 버튼 클릭 시 입력한 수량을 `onConfirm` 콜백으로 전달합니다.
 * - 수량이 입력되지 않았거나 0일 경우 팔기 버튼이 비활성화됩니다.
 *
 * ### 시각적 구성
 ...
 * - 상단 핸들 바 (드래그 인디케이터)
 * - 제목 "주식 팔기"
 * - 수량 입력 영역 (플레이스홀더: "몇 주 판매할까요?")
 * - 숫자 키패드 (1-9, 00, 0, 백스페이스)
 * - 하단 취소/팔기 버튼
 *
 * @component
 * @param {BottomSheetSellStock} props - BottomSheetSellStock 컴포넌트 속성
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 제목 */}
        <h2 className="text-head-03 text-neutral-1 text-center mb-[20px]">주식 팔기</h2>
