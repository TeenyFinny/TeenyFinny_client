 ...
 * ```
 */
export function TinyStateBadge({ enabled, label, onClick }: StateButtonProps) {
  /**
   * 버튼 클릭 이벤트 핸들러입니다.
  ...
  return (
    <button
      ...
      className={`
        ...
        w-[45px] h-[24px] px-[12px] py-[5px] rounded-[26px] transition-all whitespace-pre-line
        leading-[14px] tracking-[-0.6px] text-body-08 font-bold!
        ${
          enabled
