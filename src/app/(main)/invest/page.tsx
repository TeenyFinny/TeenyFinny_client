  ...
  return (
    <div className="px-[18px]">
      ...
      <div className="flex items-center justify-center gap-4 mb-5 mt-6">
        {/* Buy Button */}
        <a href="/invest/allStockList" className="flex flex-col items-center hover:opacity-80 transition-opacity bg-neutral-7 w-[162px] h-[120px] rounded-[16px] shadow-lg">
          <img
