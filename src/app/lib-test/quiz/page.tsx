...
export default function Page() {
  ...
  const info1 = "입금이란? \n• 돈을 내 계좌로 넣는 것을 말해요. ATM이나 앱을 통해 내 돈을 계좌 안에 **저장**하는 행동이에요.\n출금이란?\n• **계좌에 들어 있는 돈**을 바깥으로 꺼내 쓰는 것이에요. \n• 필요할 때 돈을 가져올 수 있어요!"
  const {
    setQuizData,
    quizDate,
    courseCompleted,
  ...
  return (
    ...
    >
      ...
      <div className="relative w-[327px] h-[490px] mx-auto bg-neutral-7 rounded-[16px] shadow-[0_16px_64px_-32px_rgba(0,0,0,0.16)] flex flex-col items-center pt-[160px] pb-[80px] mb-[32px]">
        ...
        {/* 중단 설명 텍스트 */}
        {(
          <div className="absolute top-[48px] left-[36px] w-[254px] mb-12">
            {info1.split("\n").map((line, index) => {
            ...
            <div className="absolute top-[265px] w-full flex justify-center">
              <img
                //src={`/images/quiz/quizinfo_${quizDate * 2 + todaySolved + 1}.png`} // ✅ 이미지 경로 설정 (public 폴더 기준)
                src="/images/quiz/quizinfo_2.png"
